class BlogUser {
  ...
  createPost(title, content) {
    // create a new blog post and add it to the user's posts array
  ...
  editPost(postTitle, newContent) {
    // find the post by title and update its content
...
const user1 = new BlogUser("leonhlabathi", "Leon Hlabathi");
const user2 = new BlogUser("brysontiler", "Bryson Tiller");
